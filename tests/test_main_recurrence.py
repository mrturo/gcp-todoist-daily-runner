...
def test_next_recurrence_weekday():
    """Test next_recurrence_date for 'cada sáb' (Saturday) pattern."""
...
def test_next_recurrence_month():
    """Test next_recurrence_date for 'cada mes' pattern."""
...
def test_next_recurrence_day():
    """Test next_recurrence_date for 'cada día' pattern."""
...
def test_next_recurrence_week():
    """Test next_recurrence_date for 'cada semana' pattern."""
